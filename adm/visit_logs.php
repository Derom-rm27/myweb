...
require_once __DIR__ . '/services/VisitLogAnalytics.php';
...
$inicioConsulta = $fechaInicio->setTime(0, 0, 0);
$finConsulta    = $fechaFin->setTime(23, 59, 59);
...
try {
    ...
    $visitRepository = new VisitLogRepository($conexion);

    $visitas        = $visitRepository->fetchVisits($inicioConsulta, $finConsulta);
    $resumenVisitas = $visitRepository->fetchDailySummary($inicioConsulta, $finConsulta);
...
$chartData       = VisitLogAnalytics::buildChartData($resumenVisitas);
$chartLabels     = $chartData['labels'];
$chartDataPoints = $chartData['data'];
$diaMasVisitado  = $chartData['peak_day'];
$maximoVisitas   = $chartData['peak_value'];

$resumenGeneral  = VisitLogAnalytics::summarize($chartDataPoints);
$totalVisitas    = $resumenGeneral['total'];
$promedioVisitas = $resumenGeneral['average'];
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<?php adminRenderNavbar('', 'visit_logs'); ?>
